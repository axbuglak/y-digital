<template>
  <section class="h-100vh md:pb-0 text-center pt-10 pb-20 container">
    <h1 class="font-bold text-darkblue mb-4 text-4xl" ref="dreamS">Dream, Design & Develop. 3 “D” of digital transformation </h1>
    <div class="relative min-h-[100vh] sm:flex-col flex justify-center items-center">
      <img src="../images/nullD.svg" alt="logo" class="ease-in-out transition delay-300 w-[40%] sm:w-[50%] sm:mx-auto" ref="dreamR">
      ...
      <p style="opacity: 0.3;" ref="dreamI3P" class="absolute bottom-0 left-[5vw] sm:relative max-w-[350px] text-darkblue mt-4 md:bottom-[10vh] sm:bottom-0 md:left-0">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
    </div>
  </section>
</template>
